...
filtered_shipment_entries = pd.read_csv('Data/filtered_shipment_entries.csv')

# Load the distance matrix
distance_matrix = pd.read_csv('Data/filtered_distance_matrix.csv', index_col=0)
...
zip_code_files_dir = 'zipCode_Clusters_3'  # Change clusters folder name

# Directory to save the individual processed files
individual_output_dir = 'data_ml/ProcessedFiles3'
