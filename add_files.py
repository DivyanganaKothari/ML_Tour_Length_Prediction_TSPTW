...
def main():
    ...
    individual_output_dir = 'data_ml/ProcessedFiles_511/ProcessedFiles'  # Path where individual processed files are saved
    ...
    combined_output_path = 'data_ml/input_features/Depot_511/combined_input_features_511.csv'
